...
RSpec.describe UsersController, type: :routing do
  describe "FR routing" do
    ...
    it { expect(get: "/utilisateurs/1").to route_to("users#show",  locale: "fr", id: "1") }
    
    it { expect(get:  "/utilisateurs/nouveau").to route_to("users#new",    locale: "fr") }
  ...
  describe "EN routing" do
    ...
    it { expect(get: "/users/1").to route_to("users#show",  locale: "en", id: "1") }
    
    it { expect(get:  "/users/new").to route_to("users#new",    locale: "en") }
